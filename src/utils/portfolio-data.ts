...
export const getExperienceSection = () => getPortfolioData().experience;
export const getAchievementsSection = () => getPortfolioData().achievements;
export const getEducationSection = () => getPortfolioData().education;
